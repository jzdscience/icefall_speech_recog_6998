...
### TDNN2 (512 3k 0d -  512 3k 0d - 512 3k 0d)
 ./conformer_ctc2/decode.py --epoch 30  --exp-dir ./conformer_ctc2/exps/exp_all_tdnn_tdnn2 --result-dir ./conformer_ctc2/exps/exp_all_tdnn_tdnn2  --max-duration 400 --method ctc-decoding --use-averaged-model True --avg 5 --num-encoder-layers 4 --num-decoder-layers 2 --conv-type all_tdnn --tdnn-type tdnn2
