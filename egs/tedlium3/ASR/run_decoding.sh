...
### Conv_TDNN8 (c-t-t-c)
 ./conformer_ctc2/decode.py --epoch 15  --exp-dir ./conformer_ctc2/exps/exp_all_tdnn_tdnn8_full --result-dir ./conformer_ctc2/exps/exp_all_tdnn_tdnn8_full  --max-duration 200 --method ctc-decoding --use-averaged-model True --avg 1 --num-encoder-layers 24 --num-decoder-layers 6 --conv-type all_tdnn --tdnn-type tdnn8
